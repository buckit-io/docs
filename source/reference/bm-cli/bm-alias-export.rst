...
The :mc:`bm alias export` command exports an alias configuration from the existing :ref:`configuration <mc-configuration>`.
...
Use the :mc:`bm alias import` command to import the resulting JSON configuration.
...
.. tab-set::
   ...
   .. tab-item:: EXAMPLE
      ...
      .. code-block:: shell
         ...
         bm alias export play > play.json
   ...
   .. tab-item:: SYNTAX
      ...
      The :mc:`bm alias export` command has the following syntax:

      .. code-block:: shell

         bm [GLOBALFLAGS] alias export ALIAS
...
You can use the :mc:`bm alias import` to import the JSON document.
...
.. code-block:: shell
   ...
   bm alias export play > play-backup.json
