...
The :mc:`bm replicate backlog` shows a list of unreplicated new or deleted objects.
...
.. tab-set::
   ...
   .. tab-item:: SYNTAX
      ...
      .. code-block:: shell
         ...
         bm [GLOBALFLAGS] replicate backlog   \
                          [--arn "string"]    \
                          TARGET
...
The following :mc:`bm replicate backlog` command shows unreplicated objects at an alias/bucket/prefix path for a specific remote target:
