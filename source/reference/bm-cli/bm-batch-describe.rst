...
The :mc:`bm batch describe` command outputs the job definition for a specified job ID.
...
.. tab-set::
   ...
   .. tab-item:: SYNTAX
      ...
      .. code-block:: shell
         ...
         bm [GLOBALFLAGS] batch describe TARGET           \
                                         JOBID
...
.. mc-cmd:: TARGET
   ...
   The :ref:`alias <alias>` for the Buckit deployment to look for the Job ID. 
