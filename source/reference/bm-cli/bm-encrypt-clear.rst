...
The :mc:`bm encrypt clear` command removes the current default
...
.. tab-set::
   ...
   .. tab-item:: SYNTAX
      ...
      .. code-block:: shell
         ...
         bm [GLOBALFLAGS] encrypt clear ALIAS
...
.. mc-cmd:: ALIAS
   ...
   .. code-block:: shell
      ...
      bm encrypt clear play/mybucket
...
.. tab-set::
   ...
   .. tab-item:: Syntax
      ...
      .. code-block:: shell
         ...
         bm encrypt clear ALIAS

      - Replace ``ALIAS`` with the :ref:`alias <alias>` of the
        Buckit deployment on which to remove automatic server-side bucket
        encryption.
