...
The :mc:`bm ilm restore` command creates a temporary copy of an object archived
...
.. mc-cmd:: ALIAS
   ...
   The Buckit :ref:`alias <alias>`, bucket, and path to the archived object to restore.
...
.. mc-cmd:: --days                     
   ...
   The number of days after which Buckit expires the restored copy of the archived object.
...
Buckit automatically expires the restored object copy after the specified
