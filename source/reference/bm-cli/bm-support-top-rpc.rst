...
The :mc:`bm support top rpc` command displays metrics for remote procedure calls (RPC).
...
.. tab-set::
   ...
   .. tab-item:: SYNTAX
      ...
      .. code-block:: shell 
         ...
         bm [GLOBALFLAGS] support top rpc                 \
                                      [--airgap]          \
                                      [--in value]        \
                                      [--interval value]  \
                                      [-n value]          \
