...
The :mc:`bm idp ldap policy entities` command displays a list of mappings for a user, group, and/or policy.
...
.. tab-set::
   ...
   .. tab-item:: SYNTAX
      ...
      .. code-block:: shell
         ...
         bm [GLOBALFLAGS] idp ldap policy entities                       \
                                          ALIAS                          \
                                          [--group `value`, -g `value`]  \
                                          [--policy value]               \
                                          [--user `value`, -u `value`]
...
.. mc-cmd:: ALIAS
   ...
   The :ref:`alias <alias>` of the Buckit deployment for which to display the entity mappings.
