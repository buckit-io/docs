...
:mc:`bm idp ldap accesskey edit` modifies the specified :ref:`access key <minio-id-access-keys>` on the local server.
...
.. tab-set::
   ...
   .. tab-item:: SYNTAX
      ...
      .. code-block:: shell
         ...
         bm [GLOBALFLAGS] idp ldap accesskey rm                        \
                                          ALIAS                        \
                                          KEY                          \
                                          [--secret-key <string>]      \
                                          [--policy <string>]          \
...
.. mc-cmd:: --expiry
   ...
   Mutually exclusive with :mc-cmd:`~bm idp ldap accesskey edit --expiry-duration`.
...
.. mc-cmd:: --expiry-duration
   ...
   Mutually exclusive with :mc-cmd:`~bm idp ldap accesskey edit --expiry`.
