...
The :mc:`bm anonymous list` retrieves all anonymous (i.e. unauthenticated or
...
.. mc-cmd:: ALIAS
   ...
   *Required* The full path to the bucket or bucket prefix for which the
   ...
   .. code-block:: shell
      ...
      bm anonymous list public play/mybucket
...
Use :mc:`bm anonymous list` to list the anonymous policies for a 
bucket:

.. code-block:: shell
   :class: copyable

   bm anonymous list ALIAS/PATH
