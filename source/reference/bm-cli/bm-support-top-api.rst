...
The :mc:`bm support top api` command summarizes the real-time API events on a Buckit deployment server.
...
.. tab-set::
   ...
   .. tab-item:: SYNTAX
      ...
      .. code-block:: shell
         ...
         bm [GLOBALFLAGS] support top api    \
                          TARGET             \
                          [--name "string"]  \
                          [--path "string"]  \
                          [--node "string"]  \
...
.. code-block:: shell
   ...
   bm support top api --name s3.PutObject myminio/
