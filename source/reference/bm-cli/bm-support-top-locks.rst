...
The :mc:`bm support top locks` command lists the ten oldest :ref:`locks <minio-object-locking>` on a Buckit deployment.
...
.. tab-set::
   ...
   .. tab-item:: SYNTAX
      ...
      .. code-block:: shell
         ...
         bm [GLOBALFLAGS] support top locks  \
                          [--stale]          \ 
                          TARGET
...
.. code-block:: shell
   ...
   bm support top locks --stale myminio/
