...
The :mc:`bm idp ldap policy detach` command detaches one or more polices from an entity.
...
.. mc-cmd:: ALIAS
   ...
   The :ref:`alias <alias>` of the Buckit deployment with the entity from which to detach a policy.
