...
.. |command| replace:: :mc:`bm stat`
.. |rewind| replace:: :mc-cmd:`~bm stat --rewind`
.. |versions| replace:: :mc-cmd:`~bm stat --versions`
.. |versionid| replace:: :mc-cmd:`~bm stat --version-id`
.. |alias| replace:: :mc-cmd:`~bm stat ALIAS`
...
The :mc:`bm stat` command displays information on objects in a Buckit bucket, including object metadata.
You can also use it to retrieve bucket metadata.

.. end-mc-stat-desc

You can use :mc:`bm stat` against the local filesystem to produce similar results to the ``stat`` commandline tool.
...
.. tab-set::
   ...
   .. tab-item:: SYNTAX
      ...
      :mc-cmd:`bm stat --version-id` is mutually exclusive with multiple parameters. See the reference documentation for more information.
...
.. mc-cmd:: ALIAS
   ...
   The :ref:`alias <alias>` of a Buckit deployment and the full path to the object for which to retrieve detailed information. For example:
...
.. mc-cmd:: --recursive, r
   ...
   Recursively :mc:`bm stat` the contents of the Buckit bucket specified to :mc-cmd:`~bm stat ALIAS`.
...
.. mc-cmd:: --versions
   ...
   Use :mc-cmd:`~bm stat --versions` and  :mc-cmd:`~bm stat --rewind` together to remove all object versions which existed at a specific point in time.
...
.. mc-cmd:: --version-id, vid
   ...
   - :mc-cmd:`~bm stat --versions`
   - :mc-cmd:`~bm stat --rewind`
   - :mc-cmd:`~bm stat --recursive`
