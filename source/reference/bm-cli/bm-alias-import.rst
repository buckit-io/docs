...
The :mc:`bm alias import` command imports an alias configuration from a JSON document.

.. end-mc-alias-import-desc

You can use :mc:`bm alias export` to create the necessary JSON for import.
...
.. tab-set::
   ...
   .. tab-item:: EXAMPLE
      ...
      Use :mc:`bm alias list newalias <bm alias list>` to confirm the import succeeded.

   .. tab-item:: SYNTAX

      The :mc:`bm alias import` command has the following syntax:
...
.. mc-cmd:: PATH
   ...
   Mutually exclusive with the :mc-cmd:`~bm alias import STDIN` parameter.
...
.. mc-cmd:: STDIN
   ...
   Mutually exclusive with the :mc-cmd:`~bm alias import PATH` parameter.
