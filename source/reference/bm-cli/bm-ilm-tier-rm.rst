...
The :mc:`bm ilm tier rm` command removes an remote tier that has not been used to transition any objects. 

.. end-mc-ilm-tier-rm-desc

The :mc:`bm ilm tier remove` command has equivalent functionality to :mc:`bm ilm tier rm`
