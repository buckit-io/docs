...
This page covers settings for the :ref:`Buckit Manager CLI <minio-client>`. 

.. note::

   Buckit Manager uses the :program:`bm` command and stores its configuration
...
Use this setting to add a temporary alias to use for :program:`bm` commands.
...
.. tab-set::
   ...
   .. tab-item:: Configuration Setting
      ...
      Use :mc:`bm alias set` to configure an :ref:`alias <alias>`.
...
.. tab-set::
   ...
   .. tab-item:: Environment Variable
      ...
      .. envvar:: MC_WEB_IDENTITY_TOKEN_FILE_<alias>
...
.. tab-set::
   ...
   .. tab-item:: Command Line Option

      Use the global ``--config-dir`` option with :program:`bm`.
