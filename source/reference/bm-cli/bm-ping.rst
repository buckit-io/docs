...
The :mc:`bm ping` command performs a liveness check on a specified target.
...
.. tab-set::
   ...
   .. tab-item:: EXAMPLE
      ...
      .. code-block:: shell
         ...
         bm ping play --count 5

      The command pings the deployment at the :mc:`~bm alias` ``play`` for five cycles.
...
.. mc-cmd:: --distributed
   ...
   Send requests to all servers in the Buckit cluster.
