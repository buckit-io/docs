...
The :mc:`bm get` command downloads an object from a target S3 deployment to the local file system.

.. end-mc-get-desc

``bm get`` provides a simplified interface for downloading files compared to :mc:`bm cp` or :mc:`bm mirror`.
``bm get`` uses a one-way download function that trades efficiency for the power and complexity of the other commands.
...
.. tab-set::
   ...
   .. tab-item:: EXAMPLE
      ...
      .. code-block:: shell
         ...
         bm get minio/marketing/logo.png ~/images/collateral
...
.. code-block:: shell
   ...
   bm get --enc-c "play/mybucket/object=MDEyMzQ1Njc4OTAxMjM0NTY3ODkwMTIzNDU2Nzg5MDA" play/mybucket/object path-to/object 