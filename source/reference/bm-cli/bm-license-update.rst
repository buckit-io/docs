...
Use the :mc-cmd:`bm license update` command to replace a license key for a deployment.

.. end-mc-license-update-desc

For deployments registered for |SUBNET|, Buckit automatically checks for and updates the license every month.
...
.. code-block:: shell
   ...
   bm license update minio1 license.key
