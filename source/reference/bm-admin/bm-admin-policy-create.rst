...
The :mc-cmd:`bm admin policy create` command accepts the following arguments:
...
.. mc-cmd:: POLICYNAME
   ...
   Specifying the name of an existing policy overwrites that policy on the :mc-cmd:`~bm admin policy create TARGET` Buckit deployment.
