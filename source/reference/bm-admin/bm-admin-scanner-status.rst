...
The :mc-cmd:`bm admin scanner status` command displays a real-time summary of :ref:`scanner <minio-concepts-scanner>` information for a Buckit Server.

.. end-mc-admin-scanner-status-desc

This command has an alias of ``bm admin scanner info``.
