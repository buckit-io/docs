...
.. tab-set::
   ...
   .. tab-item:: SYNTAX
      ...
      .. code-block:: shell
         ...
         bm admin policy info TARGET POLICYNAME
                              [--policy-file, -f <path>]
...
The :mc-cmd:`bm admin policy info` command accepts the following arguments:

.. mc-cmd:: TARGET
   :required:

   The :mc-cmd:`alias <bm alias>` of a configured Buckit deployment from which to display the specified policy.
