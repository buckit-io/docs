...
The :mc-cmd:`bm admin accesskey edit` command modifies the configuration of an access key associated to the specified user.
...
.. tab-set::
   ...
   .. tab-item:: SYNTAX
      ...
      .. code-block:: shell  
         ...
         bm [GLOBALFLAGS] admin accesskey edit                      \  
                                          ALIAS                     \  
                                          ACCESSKEY                 \
                                          [--description string]    \
...
.. mc-cmd:: --expiry
   ...
   Mutually exclusive with :mc-cmd:`~bm admin accesskey edit --expiry-duration`.
...
.. mc-cmd:: --expiry-duration
   ...
   Mutually exclusive with :mc-cmd:`~bm admin accesskey edit --expiry`.
