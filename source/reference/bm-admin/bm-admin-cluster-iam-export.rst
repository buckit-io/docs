...
The command saves the output as ``ALIAS-iam-metadata.zip``, where ``ALIAS`` is the :mc:`alias <bm admin cluster iam export ALIAS>` of the Buckit deployment.
...
.. mc-cmd:: ALIAS
   ...
   The :ref:`alias <alias>` of the Buckit deployment to export IAM metadata for.
