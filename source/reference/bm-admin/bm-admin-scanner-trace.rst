...
The :mc-cmd:`bm admin scanner trace` command displays :ref:`scanner <minio-concepts-scanner>`-specific API operations occurring on the target Buckit deployment.
...
.. mc-cmd:: ALIAS
   ...
   The :ref:`alias <alias>` of the Buckit deployment for which to display :ref:`scanner <minio-concepts-scanner>` API operations.

.. mc-cmd:: --filter-request
   :optional:

   Trace scanner operations or calls with request size greater than the specified :mc-cmd:`~bm admin scanner trace --filter-size` value.

   **Must** be used with :mc-cmd:`~bm admin scanner trace --filter-size` flag.

.. mc-cmd:: --filter-response
   :optional:

   Trace scanner operations or calls with response size greater than the specified :mc-cmd:`~bm admin scanner trace --filter-size` value.
...
.. mc-cmd:: --filter-size
   ...
   Must be used with either :mc-cmd:`~bm admin scanner trace --filter-request` or :mc-cmd:`~bm admin scanner trace --filter-response` flag.
...
Use :mc-cmd:`bm admin scanner trace` to monitor large response sizes:
...
Use :mc-cmd:`bm admin scanner trace` to monitor long operations:
