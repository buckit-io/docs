# AWS CLI with Buckit Server [![Slack](https://slack.min.io/slack?type=svg)](https://slack.min.io)
...
In this recipe we will learn how to configure and use AWS CLI to manage data with Buckit Server.
...
To configure AWS CLI, type `aws configure` and specify the Buckit key information.

Access credentials shown in this example belong to <https://play.min.io:9000>.
These credentials are open to public. Feel free to use this service for testing and development. Replace with your own Buckit keys in deployment.
...
Additionally enable AWS Signature Version '4' for Buckit server.
