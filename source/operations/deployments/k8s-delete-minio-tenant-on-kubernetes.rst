...
.. warning::
   ...
   Deletion of the underlying ``PV``, whether automatic or manual, results in the loss of any objects stored on the Buckit Tenant. 
...
.. tab-set::
   ...
   .. tab-item:: Kustomization
      ...
      .. important::
         ...
         Namespace removal occurs at the Kubernetes layer, such that the Buckit Operator cannot interfere with nor undo the operation.
