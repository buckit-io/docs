.. _buckit-getting-started-remote:

=================================
Getting Started on Remote Servers
=================================
...
provides the web interface and wizard used to install Buckit on target hosts.
...
2. Select :guilabel:`Remote servers`.
3. Enter a cluster name and root credentials.
4. Add the target hostnames and SSH credentials.
5. Let Buckit Manager discover the hosts and drives.
6. Select the drives you want to use.
7. Review the settings and start the deployment.

If Buckit Manager is running on Linux, selecting :guilabel:`Deploy a new
cluster` opens the remote servers wizard directly.
...
- See the detailed remote servers deployment guide in
  :ref:`deploy-buckit-guided-bm-remote`
