...
Buckit SSE uses the :minio-git:`Buckit Key Encryption Service (KES) <kes>` and an
...
Buckit supports the following |KMS| as the central key store:
...
Buckit SSE is feature and API compatible with 
...
.. tab-set::
   ...
   .. tab-item:: SSE-KMS *Recommended*
      ...
      Buckit supports enabling automatic SSE-KMS encryption of all objects
   ...
   .. tab-item:: SSE-S3
      ...
      For a tutorial on enabling SSE-s3 in a local (non-production) Buckit Deployment, see :ref:`minio-encryption-sse-s3-quickstart`.
