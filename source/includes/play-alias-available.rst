...
:mc-cmd:`bm` :ref:`configuration file <mc-configuration>`. You can
replace ``play`` with the alias for your preferred S3-compatible deployment.

See :mc:`bm alias` for more information on aliases.
...
:mc-cmd:`bm` :ref:`configuration file <mc-configuration>`. You can replace
